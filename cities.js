...
// `pdf` is the actual sold deliverable; `intro` is the brief description
// shown on the city's product page (the only content we give away).
// Add, remove or reorder entries freely — the site reads from this list.

window.TEA_CITIES = [
  { id:'bcn', name:'Barcelona',       short:'Barcelona',       country:'Spain',          coords:'41.4° N · 2.2° E',    season:'Late spring',     tag:'Gothic Quarter · Barceloneta · Gràcia',                 cover:'covers/barcelona.jpg',       pdf:'guides/barcelona.pdf',       accent:'#7a2a14', no:'01',
  ...
  { id:'cpt', name:'Cape Town',       short:'Cape Town',       country:'South Africa',   coords:'33.9° S · 18.4° E',   season:'January',         tag:'Camps Bay · Waterfront · Winelands',                    cover:'covers/cape-town.jpg',       pdf:'guides/cape-town.pdf',       accent:'#1d3025', no:'02',
  ...
  { id:'grc', name:'Greece',          short:'Greece',          country:'Greece',         coords:'37.0° N · 25.0° E',   season:'May – early Oct', tag:'Athens · Santorini · Mykonos · Corfu',                  cover:'covers/greece.jpg',          pdf:'guides/greece.pdf',          accent:'#0f2a5a', no:'03',
  ...
  { id:'haw', name:'Hawai\u02bbi',    short:'Hawai\u02bbi',    country:'United States',  coords:'21.3° N · 157.8° W',  season:'Year-round',      tag:'O\u02bbahu · Maui · Kona · Kaua\u02bbi',                cover:'covers/hawaii.jpg',          pdf:'guides/hawaii.pdf',          accent:'#0f2a35', no:'04',
  ...
  { id:'ibz', name:'Ibiza',           short:'Ibiza',           country:'Spain',          coords:'38.9° N · 1.4° E',    season:'Shoulder season', tag:'Old Town · Las Salinas · Sunset Strip',                 cover:'covers/ibiza.jpg',           pdf:'guides/ibiza.pdf',           accent:'#2c1a4a', no:'05',
  ...
  { id:'ldn', name:'London',          short:'London',          country:'England',        coords:'51.5° N · 0.1° W',    season:'May & September', tag:'Mayfair · Notting Hill · Shoreditch',                   cover:'covers/london.jpg',          pdf:'guides/london.pdf',          accent:'#11182a', no:'06',
  ...
  { id:'mar', name:'Marrakech',       short:'Marrakech',       country:'Morocco',        coords:'31.6° N · 8.0° W',    season:'Early spring',    tag:'Medina · Majorelle · Palmeraie · Souks',                cover:'covers/marrakech.jpg',       pdf:'guides/marrakech.pdf',       accent:'#3d1f10', no:'07',
  ...
  { id:'mex', name:'Mexico City',     short:'Mexico City',     country:'Mexico',         coords:'19.4° N · 99.1° W',   season:'October – April', tag:'Condesa · Roma · Polanco · Centro',                     cover:'covers/mexico-city.jpg',     pdf:'guides/mexico-city.pdf',     accent:'#241038', no:'08',
  ...
  { id:'par', name:'Paris',           short:'Paris',           country:'France',         coords:'48.9° N · 2.3° E',    season:'September',       tag:'Le Marais · Saint-Germain · Montmartre',                cover:'covers/paris.jpg',           pdf:'guides/paris.pdf',           accent:'#161a3a', no:'09',
  ...
  { id:'sof', name:'South of France', short:'South of France', country:'France',         coords:'43.7° N · 7.3° E',    season:'Late spring',     tag:'C\u00f4te d\u2019Azur · Saint-Tropez · Monaco',         cover:'covers/south-of-france.jpg', pdf:'guides/south-of-france.pdf', accent:'#13254b', no:'10',
  ...
  { id:'ita', name:'Southern Italy',  short:'Southern Italy',  country:'Italy',          coords:'40.6° N · 14.5° E',   season:'May / September', tag:'Amalfi · Positano · Sicily · Puglia',                   cover:'covers/southern-italy.jpg',  pdf:'guides/southern-italy.pdf',  accent:'#1d2f1d', no:'11',
  ...
  { id:'syd', name:'Sydney',          short:'Sydney',          country:'Australia',      coords:'33.9° S · 151.2° E',  season:'Southern summer', tag:'Bondi · Harbour · Manly · Paddington',                  cover:'covers/sydney.jpg',          pdf:'guides/sydney.pdf',          accent:'#1d3025', no:'12',
  ...
  { id:'tam', name:'Tamarindo',       short:'Tamarindo',       country:'Costa Rica',     coords:'10.3° N · 85.8° W',   season:'December – April',tag:'Guanacaste · Pacific · Surf · Jungle',                  cover:'covers/tamarindo.jpg',       pdf:'guides/tamarindo.pdf',       accent:'#1d3023', no:'13',
  ...
  { id:'tyo', name:'Tokyo',           short:'Tokyo',           country:'Japan',          coords:'35.7° N · 139.7° E',  season:'Autumn',          tag:'Ginza · Shibuya · Shimokitazawa',                       cover:'covers/tokyo.jpg',           pdf:'guides/tokyo.pdf',           accent:'#0e0d18', no:'14',
